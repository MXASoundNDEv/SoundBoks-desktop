...
class BLEManager {
    constructor() {
        ...
        this.messageDelay = 200; // Délai entre les messages en millisecondes (modifiable)
        this.scanTimeout = 10000; // Durée maximale du scan BLE en millisecondes (modifiable)
    }
    ...
    async _processQueue() {
        ...
        while (this.messageQueue.length > 0) {
            ...
            try {
                console.log(`✉️ Traitement du message : ${uuidName} - ${value}`);
